                ...
                <form method="POST" action="index.php?route=moto/new" class="form-horizontal form-label-left">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="text" name="marque" required="required" class="form-control" placeholder="Ex: Honda, Yamaha, etc.">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="text" name="modele" required="required" class="form-control" placeholder="Ex: CBR 1000RR-R">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="number" name="cylindree" required="required" class="form-control" 
                                   min="125" max="2000" step="1" placeholder="Ex: 1000">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="number" name="poids" required="required" class="form-control" 
                                   min="100" max="400" step="0.1" placeholder="Ex: 201.5">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="number" name="puissance" required="required" class="form-control" 
                                   min="15" max="300" step="1" placeholder="Ex: 217">
                        </div>
                    </div>
