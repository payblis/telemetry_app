...
try {
    ...
    $databaseFile = ROOT_PATH . 'app/config/database.php';
    if (!file_exists($databaseFile)) {
        throw new Exception("Database configuration file not found: " . $databaseFile);
    }
    ...
    require_once APP_PATH . '/views/500.php';
    exit();
}
